...
<head>
	...
	<!-- Style -->
	<link rel="stylesheet" href="../assets/css/styleadmin.css" type="text/css" media="all" />
</head>
	...
	<section class="w3l-login-form">
		<div id="form-section">
			<div class="wrapper">
				...
				<!-- logo -->
				<div class="logo">
					<a class="brand-logo" href="index.html">Admin login </a>
				</div>
				<!-- //logo -->
				...
				<div class="copy-right">
					<p>&copy; 2020 BRSBD . All rights reserved | Design by Infinity & Beyond</p>
				</div>
